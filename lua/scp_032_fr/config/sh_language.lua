...
--]]
function scp_032_fr.AddLanguage(langName, data)
...
--]]
function scp_032_fr.GetTranslation(name)
    local langUsed = SCP_032_FR_CONFIG.LangServer
    if not SCP_032_FR_LANG[langUsed] then
        langUsed = "en" -- Default lang is EN.
    end
    return string.format( SCP_032_FR_LANG[langUsed][ name ] or "Not Found" )
end